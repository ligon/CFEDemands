...
class Result(xr.Dataset):
    ...
    def __init__(self,**kwargs):
        ...
        if not attrs['useless_expenditures']: 
            _drop_useless_expenditures(arrs,attrs,coords)
...
=Result(y=y,z=z,useless_expenditures=True)=.
...
def _drop_useless_expenditures(arrs,attrs,coords,VERBOSE=False):
    ...
    try:
        arrs['prices'] = arrs['prices'].sel(i=y.coords['i'])
        arrs['logp'] = np.log(arrs['prices'])
    except AttributeError:
        pass # No prices in self?
...
#+RESULTS: test_drop_useless_expenditures
...
#+RESULTS: test_get_stderrs
#+begin_example
Draws 4, delta=0.0067.  Measure of non-normality 0.22184.
Draws 6, delta=0.0039.  Measure of non-normality 0.45318.
Draws 8, delta=0.0003.  Measure of non-normality 0.52243.
Draws 10, delta=0.0009.  Measure of non-normality 0.55395.
Draws 12, delta=0.0008.  Measure of non-normality 0.70493.
Draws 14, delta=0.0007.  Measure of non-normality 0.72970.
Draws 16, delta=0.0012.  Measure of non-normality 0.65300.
Draws 18, delta=0.0045.  Measure of non-normality 0.35036.
Draws 20, delta=0.0007.  Measure of non-normality 0.38254.
Draws 22, delta=0.0011.  Measure of non-normality 0.31243.
Draws 24, delta=0.0006.  Measure of non-normality 0.28178.
Draws 26, delta=0.0005.  Measure of non-normality 0.29586.
Draws 28, delta=0.0005.  Measure of non-normality 0.25582.
#+end_example
