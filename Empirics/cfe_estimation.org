...
#+begin_src python :exports none :tangle cfe_estimation.py
  import pylab as pl 
  import pandas as pd
  import numpy as np
...
#+begin_src python :noweb yes :tangle cfe_estimation.py
...
#+begin_src python :noweb no-export :results output :tangle cfe_estimation.py
  import pandas as pd
  <<svd_missing>>
...
#+BEGIN_SRC python :tangle cfe_estimation.py
