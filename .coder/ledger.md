...
| `Regression.score_w` | R.org:1563 | scores additional households with fitted loadings, demographic transformation, and market intercept; returns support diagnostics on request | `test_preparation_scoring.py` |
